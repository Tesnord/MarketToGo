            ...
            <div class="pay-list">
                <div class="pay-list__inner">
                    <div class="pay-list__row">
                        ...
                        <div class="pay-list__title">Банковской картой онлайн</div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-12 col-md-12">
                                <div class="pay-descrip__item">
                                    <div class="pay-descrip__item-title">Наличия в заказе весовых товаров</div>
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-12">
                                <div class="pay-descrip__item">
                                    <div class="pay-descrip__item-title">Замены или отсутствия</div>
